...
import { Flag, RefreshCw, Users, Download, Upload, Home, Moon, Sun, HelpCircle, BookOpen } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900">
      ...
      {/* Main content */}
      <main className={tab === 'home' ? '' : 'px-4 sm:px-6 py-6'}>
        ...
        {tab === 'home' && (
          <HomePage
            ...
            toggleTab={toggleTab as (id: string) => void}
            setTab={setTab as (id: string | 'home') => void}
            t={t}
